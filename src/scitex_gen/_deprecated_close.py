...
from scitex_decorators._deprecated import deprecated
...
def close(*args, **kwargs):
    ...
    **kwargs : dict
    ...
    from scitex_session import close as session_close
...
def running2finished(*args, **kwargs):
    ...
    **kwargs : dict
    ...
    """
    # Import here to avoid circular dependencies
    from scitex_session import running2finished as session_running2finished
